...
void xnn_f16_vclamp_ukernel__rvvfp16arith_u4v(
    size_t batch,
    const void* input,
    void* output,
    const union xnn_f16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    i += n;
    vacc = __riscv_vfmax_vf_f16m4(vacc, vmin, n);
    vacc = __riscv_vfmin_vf_f16m4(vacc, vmax, n);
    __riscv_vse16_v_f16m4((void*) o, vacc, n);
    o += n;
